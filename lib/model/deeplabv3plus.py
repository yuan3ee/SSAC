...
class DeepLabV3Plus(nn.Module):
    def __init__(self, num_class, backbone='resnet50'):
        super(DeepLabV3Plus, self).__init__()
        self.backbone_name = backbone
        if 'resnet' in backbone:
            # self.backbone = resnet.__dict__[backbone](pretrained='/home/su8/LY/pretrained/resnet50-19c8e357.pth',
            #                                                  replace_stride_with_dilation=[False, False, True])
            if 'resnet50' in backbone:
                self.backbone = ResNetBackbone('/home/su8/lsy/pretrained/resnet50-19c8e357.pth')(arch=backbone)
            elif 'resnet101' in backbone:
                self.backbone = ResNetBackbone('/home/su8/lsy/pretrained/resnet101-5d3b4d8f.pth')(arch=backbone)
        else:
        ...
        self.classifier = nn.Conv2d(256, num_class, 1, bias=True)
        ...
        self.pred_contrast = nn.Sequential(nn.Conv2d(256, num_class, 1))
    ...
    def forward(self, x, need_fp=False):
        ...
        if need_fp:
            ...
            return out, out_fp, fea_con, pre_con
